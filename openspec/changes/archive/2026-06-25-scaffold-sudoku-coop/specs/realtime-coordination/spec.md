...
<!--
NOTE: This capability documents the FUTURE product contract that the scaffold targets.
The scaffolding change does NOT implement these behaviors; it only records them as the
requirements that later implementation work must satisfy. Each requirement below is the
intended end-state behavior of the MVP.
-->
